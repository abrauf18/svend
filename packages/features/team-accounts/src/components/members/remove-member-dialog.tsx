  ...
  return (
    <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>
            <Trans i18nKey="budgets:removeMemberModalHeading" />
          </AlertDialogTitle>

          <AlertDialogDescription>
            <Trans i18nKey={'budgets:removeMemberModalDescription'} />
          </AlertDialogDescription>
        </AlertDialogHeader>
    ...
    <form action={onMemberRemoved}>
      <div className={'flex flex-col space-y-6'}>
        ...
        <AlertDialogFooter>
          ...
          >
            <Trans i18nKey={'budgets:removeMemberSubmitLabel'} />
          </Button>
        </AlertDialogFooter>
      </div>
    </form>
...
function RemoveMemberErrorAlert() {
  return (
    <Alert variant={'destructive'}>
      <AlertTitle>
        <Trans i18nKey={'budgets:removeMemberErrorHeading'} />
      </AlertTitle>

      <AlertDescription>
        <Trans i18nKey={'budgets:removeMemberErrorMessage'} />
      </AlertDescription>
    </Alert>
  );
}
