          ...
          <FormField
            ...
            render={({ field }) => {
              return (
                <FormItem>
                  <FormLabel>
                    <Trans i18nKey={'budgets:budgetNameLabel'} />
                  </FormLabel>
                  ...
                  <FormDescription>
                    <Trans i18nKey={'budgets:budgetNameDescription'} />
                  </FormDescription>
...
function CreateOrganizationErrorAlert() {
  return (
    <Alert variant={'destructive'}>
      <AlertTitle>
        <Trans i18nKey={'budgets:createTeamErrorHeading'} />
      </AlertTitle>

      <AlertDescription>
        <Trans i18nKey={'budgets:createTeamErrorMessage'} />
      </AlertDescription>
    </Alert>
  );
}
