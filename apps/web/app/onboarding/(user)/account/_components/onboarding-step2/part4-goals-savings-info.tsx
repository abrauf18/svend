...
export function SavingsInformation(props: {
  initialData: any;
        ...
        <form className={'flex flex-col space-y-4'}>
          <div className={'flex flex-col space-y-4'}>
            ...
            <h2 className="mb-4 text-xl font-semibold">
              <Trans i18nKey={'onboarding:goalsHeading'} defaults="Savings" />
            </h2>
            ...
            <div className="w-2/5">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      <Trans i18nKey={'onboarding:savingsNameLabel'} />
                    </FormLabel>
                    <FormControl>
                      <Input
                        data-test={'savings-form-name-input'}
                        required
                        type={'text'}
                        {...field}
                        value={field.value ?? ''}
            ...
            <div className="w-2/5">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      <Trans i18nKey={'onboarding:budgetGoals.savingsAmount'} />
                    </FormLabel>
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input
                          className="pl-7"
                          data-test={'savings-form-amount-input'}
                          required
                          type={'number'}
                          {...field}
                          value={field.value ?? ''}
                  ...
                  return (
                    <FormItem>
                      ...
                      <FormControl>
                        ...
                        >
                          <SelectTrigger data-test={'savings-form-account-selector-trigger'}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        data-test={'savings-form-description-input'}
                        type={'text'}
                        {...field}
                        value={field.value ?? ''}
                      />
