...
function OnboardingStep1ConnectPlaidAccounts(props: { nextStepAccount: () => void; prevStepAccount: () => void }) {
    return (
      <div className="w-full max-w-4xl mx-auto p-4">
        <Card className="w-full">
          ...
          <CardContent className="space-y-4">
            ...
            <ConnectPlaidAccountsButton redirectType="budget" />
          </CardContent>
          <CardFooter>
            <Button variant="outline" className="w-full md:w-auto" onClick={props.nextStepAccount}>
