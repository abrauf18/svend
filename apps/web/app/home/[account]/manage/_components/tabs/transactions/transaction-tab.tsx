...
import TransactionMonthlyExpenseSummary from './transaction-monthly-expense-summary';
import { TransactionTable } from './transaction-tab-table';
    ...
    <>
      <div className="flex w-full flex-col">
        ...
        <div className="flex w-full flex-col lg:flex-row">
          <div className="min-w-full lg:min-w-[300px] lg:w-[300px] lg:order-2 lg:pl-4">
            <div className="w-[300px] mx-auto">
              <TransactionMonthlyExpenseSummary selectedDate={selectedDate} />
            </div>
          </div>

          <div className="flex-grow overflow-hidden lg:order-1">
