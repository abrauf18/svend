...
interface RecurringCategorySelectProps {
  value?: string;
...
export function RecurringCategorySelect({
  value,
  onValueChange,
  categoryGroups,
  disabled,
  placeholder = "Select category"
}: RecurringCategorySelectProps) {
    ...
    >
      ...
      <SelectPrimitive.Portal>
        <SelectPrimitive.Content
          className="relative z-[60] w-[var(--radix-select-trigger-width)] overflow-hidden rounded-md border bg-popover text-popover-foreground shadow-[0_4px_12px_rgba(255,255,255,0.2)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2"
          position="popper"
          sideOffset={5}
