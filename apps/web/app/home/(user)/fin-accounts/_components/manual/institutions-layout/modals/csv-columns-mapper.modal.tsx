...
import { FinAccountsMgmtManualInstitution } from '~/lib/model/fin-accounts-mgmt.types';
type Props = {
...
export default function CsvColumnsMapperModal({
  ...
  const { accountManualInstitutionsAddMany } = useFinAccountsMgmtContext();
  ...
  async function handleSubmit() {
    ...
    const res = await fetch('/api/fin-account-mgmt/manual/csv/mapped', {
      method: 'POST',
      body: JSON.stringify({
