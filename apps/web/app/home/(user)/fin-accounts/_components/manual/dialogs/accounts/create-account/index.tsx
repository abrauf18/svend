...
export default function CreateAccount({
  ...
  const { accountManualAccountAddOne } = useFinAccountsMgmtContext();
  ...
  async function handleCreateAccount(data: z.infer<typeof accountSchema>) {
    ...
    try {
      ...
      const res = await fetch('/api/fin-account-mgmt/manual/accounts', {
        method: 'POST',
        body: JSON.stringify({ 
          ...data, 
      ...
      accountManualAccountAddOne(institution.id, {
        ...
        type: data.type,
        transactions: [],
        budgetFinAccountIds: budgetId ? [budgetId] : [],
        institutionId: institution.id,
        mask: data.mask,
        balanceCurrent: parseFloat(data.balanceCurrent),
      });
